...
def softmax(x):
  ...
  ### YOUR CODE HERE
  out = x - tf.reduce_max(x, reduction_indices=-1, keep_dims=True)
  out = tf.exp(out)
  out /= tf.reduce_sum(out, reduction_indices=-1, keep_dims=True)
  ### END YOUR CODE
...
def cross_entropy_loss(y, yhat):
  ...
  """
  ### YOUR CODE HERE
  out = -tf.reduce_sum(tf.mul(tf.log(yhat), tf.to_float(y)))
  ### END YOUR CODE
  return out
