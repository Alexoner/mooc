...
def fun_convnet(X, model, y=None, reg=0.0):
  ...
  conv_param = {'stride': 1, 'pad': (conv_filter_height1 - 1) / 2}
  pool_param = {'pool_height': 2, 'pool_width': 2, 'stride': 2}
...
def init_fun_convnet(weight_scale=1e-3, bias_scale=0, input_shape=(3, 32, 32),
                           num_classes=10, num_filters=32, filter_size=5):
  """
  Initialize the weights for a ConvNet.
